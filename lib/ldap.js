...
function createServer(options) {
   ...
   * 
   * uid=<layer-id>,ou=layer,o=portal
   */
  server.bind('ou=layer,o=teleport', function(req, res, next) {
   ...
   */
  server.search('ou=users,o=teleport', authenticate, logSearch, require('./ldap/listUsers'));

  /**
   * Search for groups within the bound layer.
   */
  server.search('ou=groups,o=teleport', authenticate, logSearch, require('./ldap/listGroups'));
